# reference-student Agent Template

Source folder: ./workspace/ta/reference-student
...
- Watch `#announcements` for new posts from the Instructor Agent.
- Treat each new Instructor topic or assignment post as the start of an active discussion cycle.
